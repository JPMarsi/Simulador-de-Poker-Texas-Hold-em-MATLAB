function [OPTION]=turnycomputadora(cartas_comunitarias, cartas_computadora, mapacartas)

floptotal=[cartas_comunitarias(1:4), cartas_computadora];

 % Obtener los valores numéricos de las cartas (quitando el palo)
    valores=cellfun(@(cartas) mapacartas(cartas(1:end-1)), floptotal);

function [FICHAS,aportes_juego,numero_tres,fold_A,opcion,all_in,botes,jug_AI,ALL_IN]=flopV20(FICHAS,orden_jugadores,aportes_juego,fold_A,opcion,all_in,botes,jug_AI,ALL_IN,ronda,cartas_computadora1,cartas_computadora2,mapacartas,cartas_comunitarias)
